...
public class RefreshRecyclerView extends WrapRecyclerView {
    String TAG="RefreshRecyclerView";
    // 下拉刷新的辅助类
    ...
    // 默认状态
    public int REFRESH_STATUS_NORMAL = 0x0011;//16进制,对应十进制17
    // 下拉刷新状态
    public int REFRESH_STATUS_PULL_DOWN_REFRESH = 0x0022;//16进制,对应十进制34
    // 松开刷新状态
    public int REFRESH_STATUS_LOOSEN_REFRESHING = 0x0033;//16进制,对应十进制51
    // 正在刷新状态
    public int REFRESH_STATUS_REFRESHING = 0x0044;//16进制,对应十进制68
    private boolean isKickbacking=false;
    ...
    private void restoreRefreshView() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                //Log.e(TAG, "onAnimationUpdate: currentTopMargin="+currentTopMargin);
            }
        });
        //setTranslationY(11);
        animator.start();
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_MOVE:
                ...
                if (distanceY > 0) {
                    ...
                    mCurrentDrag = true;
                    //Log.e(TAG, "refreshView height: "+marginTop+ " px");
                    return false;
                }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
       ...
       Log.e(TAG,"onLayout");
        //控件第一次调用onLayout changed为true 其余例如改变margin值并不会使changed为true,有待考究
        if (changed) {
...
//        Log.e(TAG, "onScrolled: curState="+mCurrentRefreshStatus);
//        if (!canScrollUp() &&!isKickbacking&& haveTouched){
//            if (isTouch){
//                Log.e(TAG, "拖拽到顶部" );
//            }else {
//                Log.e(TAG, "滑动到顶部");
...
//    }
//
//    private void kickBackAction() {
//        int currentTopMargin = ((MarginLayoutParams) mRefreshView.getLayoutParams()).topMargin;
//        int finalTopMargin = -mRefreshViewHeight + DisplayUtil.dip2px(context,30);
//        int distance = Math.abs(currentTopMargin - finalTopMargin);
//        // 回弹到指定位置
//        ValueAnimator animator = ObjectAnimator.ofFloat(0, -(DisplayUtil.dip2px(context,30))).setDuration(2000);
//        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
//            @Override
//            public void onAnimationUpdate(ValueAnimator animation) {
//                float currentTopMargin = (float) animation.getAnimatedValue();
...
//                    isKickbacking=false;
//                    Log.e(TAG, "kickBackAction finished: ");
//                }
//            }
//        });
//        //setTranslationY(11);
